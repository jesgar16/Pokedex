...
2. Crea una cuenta y ve a **API Keys** → crea una clave (empieza con `sk-ant-`)
3. Carga un poco de crédito (cada identificación cuesta menos de un centavo de dólar)
...
- La app necesita internet para identificar (IA) y para pokémones nuevos; los ya escaneados quedan en caché y funcionan offline.
